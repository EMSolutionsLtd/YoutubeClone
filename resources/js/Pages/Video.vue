...
<template>
    ...
    <NavLayout>
        <div class="xl:flex">
            <div class="p-3">
                <video :src="video.video || ''" class="w-[100%]" controls autoplay></video>
                ...
                <div class="flex items-center mb-4">
                    <img class="rounded-full m-1.5 mt-2 flex items-baseline w-8 h-8"
                            :src="`https://picsum.photos/id/${(Math.random()*100).toFixed(0)}/100` || ''" src="" alt="">
                    <div class="pl-2 mt-1">
                ...
                <div class="mt-6">
                    ...
                    <div v-for="comment in comments" :key="comment">
                        <div class="flex items-flex mb-4 mt-2">
                            <img class="rounded-full mt-2 w-12 h-12" :src="`https://picsum.photos/id/${(Math.random()*100).toFixed(0)}/100` || ''" alt="">
                            <div class="pl-6 mt-1">
